...
void World::build_world() {
	...
	Vec3 lookfrom{ 0,0.75,1.95f };
	Vec3 lookat{ 0,0.75,0 };
	...
	helmetsMat->m_baseColor = Vec3(1);
	helmetsMat->m_specular = 1;
	helmetsMat->m_roughness = 0;
	helmetsMat->m_metallic = 0.4;
